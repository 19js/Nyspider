...
class Psddata(Ui_MainWindow,QtWidgets.QMainWindow):
    ...
    def addgroup(self):
        ...
        self.group.append([commodity,datatype,country,year])
        self.listshow()
    ...
    def getdata(self):
        self.psd=GetPsd(self.group,self.commodity_values,self.datatype,self.country_values)
...
class GetPsd(QtCore.QThread):
    ...
    def __init__(self,group,commodity_values,datatype,country_values,parent=None):
